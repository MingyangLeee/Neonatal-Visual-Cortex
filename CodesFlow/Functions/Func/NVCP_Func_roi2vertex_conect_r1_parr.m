...
empty_gdata{1} = gifti('/home/limingyang/WorkSpace/dHCP/Masks/Bozek2018/dHCP.week36.R.MyelinMap.func.gii');
empty_gdata{2} = gifti('/home/limingyang/WorkSpace/dHCP/Masks/Bozek2018/dHCP.week36.L.MyelinMap.func.gii');
%% data and calculate
mkdir(['/home/limingyang/WorkSpace/dHCP/Results/IndividualSurface/D40/',SubNames{subi},'/Func/',ROIName,'_',suffix]);
...
for hi = 1 : 2
    ...
    output = ['/home/limingyang/WorkSpace/dHCP/Results/IndividualSurface/D40/',SubNames{subi},'/Func/',ROIName,'_',suffix,'/r_map_',hem{hi},'.func.gii'];       
    gifti_save(empty_gdata{hi},output,'ASCII');
    empty_gdata{hi}.cdata = p(versize*(hi-1)+1:versize*hi);
    output = ['/home/limingyang/WorkSpace/dHCP/Results/IndividualSurface/D40/',SubNames{subi},'/Func/',ROIName,'_',suffix,'/p_map_',hem{hi},'.func.gii'];       
    gifti_save(empty_gdata{hi},output,'ASCII');   
end