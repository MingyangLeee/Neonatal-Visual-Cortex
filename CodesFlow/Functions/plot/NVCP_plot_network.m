...
%%  brain map 
if 1
giidata = gifti('/home/limingyang/WorkSpace/NVCP/Results/1surface/VOTC34_R.label.gii');
...
for i = subsets'
    ...
    output = ['/home/limingyang/WorkSpace/NVCP/Results/AveragedSurface/term/MDS/VOTC_MDS',num2str(i),'_R.label.gii'];
